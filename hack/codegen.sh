...
PACKAGE_NAME=github.com/kubedb/user-manager
...
docker run --rm -ti -u $(id -u):$(id -g) \
  ...
  --input-dirs "$PACKAGE_NAME/apis/authorization/v1alpha1,k8s.io/apimachinery/pkg/apis/meta/v1,k8s.io/apimachinery/pkg/api/resource,k8s.io/apimachinery/pkg/runtime,k8s.io/apimachinery/pkg/version,k8s.io/api/core/v1,k8s.io/api/rbac/v1,github.com/appscode/go/encoding/json/types" \
