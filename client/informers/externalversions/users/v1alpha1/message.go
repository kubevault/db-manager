	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.UsersV1alpha1().Messages(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.UsersV1alpha1().Messages(namespace).Watch(options)
			},
		},
		&users_v1alpha1.Message{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *messageInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&users_v1alpha1.Message{}, f.defaultInformer)
}
